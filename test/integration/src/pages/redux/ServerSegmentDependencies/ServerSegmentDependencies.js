...
class Component extends React.Component {
  render() {
    return <div>
      ...
      <RandomTimeEchoString context={this.props.context} value={'Quick Fox'} />
      ...
      <RandomTimeEchoString context={this.props.context} value={'Jumps Over'} isParallel={true} />
      ...
      <h4>Serial-Serial</h4>
      <RandomTimeEchoString context={this.props.context} value={'Olsen'} shouldReplace={true} />
      <h4>Serial-Parallel</h4>
      <RandomTimeEchoString context={this.props.context} value={'Olsen'} shouldReplace={true} isReplaceParallel={true} />
      <h4>Parallel-Serial</h4>
      <RandomTimeEchoString context={this.props.context} value={'Olsen'} shouldReplace={true} isParallel={true} />
      <h4>Parallel-Parallel</h4>
      <RandomTimeEchoString context={this.props.context} value={'Olsen'} shouldReplace={true} isParallel={true} isReplaceParallel={true} />
      ...
      <FibonacciSequence context={this.props.context} number={10} />
      <h3>Recursive Segment Dependencies</h3>
      <FibonacciTotal context={this.props.context} number={10} />
